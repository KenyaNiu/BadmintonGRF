"""TCN + BiLSTM — primary sequence baseline (legacy name: LSTMBaseline)."""
...
class TCNBiLSTM(nn.Module):
    """Temporal CNN + bidirectional LSTM + frame-wise regression head."""
...
# Backward-compatible name used across the codebase and checkpoints
LSTMBaseline = TCNBiLSTM
