...
% Public code/data URL (replace TBD-ORG/TBD-REPO once the GitHub org and repository names are fixed).
\newcommand{\BadmintonGRFGitHubBase}{https://github.com/TBD-ORG/TBD-REPO}
